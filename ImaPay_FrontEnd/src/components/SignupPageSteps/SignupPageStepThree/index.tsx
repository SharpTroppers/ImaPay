      ...
      <main className={styles["main-container-style"]}>
        ...
        >
          ...
          >
            <p
              className={
                errorListObj.capitalLetterError
                  ? styles["error-message-style"]
                  : ""
              }
            >
              * Uma letra maiuscula.
            ...
            <p
              className={
                errorListObj.lowercaseLetterError
                  ? styles["error-message-style"]
                  : ""
              }
            >
            ...
            <p
              className={
                errorListObj.simbolError ? styles["error-message-style"] : ""
              }
            >
              * Um simbolo.
            </p>
            <p
              className={
                errorListObj.numberError ? styles["error-message-style"] : ""
              }
            >
              * Um número.
            </p>
