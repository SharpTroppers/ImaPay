...
const SignupPageStepTwo = ({
  ...
  const getPostalCodeAddressData = async (postalCodeCleanValue: string) => {
    try {
      const { data } = await axios.get(
        `https://viacep.com.br/ws/${postalCodeCleanValue}/json/`
      );
      setTimeout(() => {
        ...
        const stateName: any = stateNamesArray.find(
          (state: any) => state.sigla === uf
        );

        setValue("stateName", stateName?.nome || "Error", {
  ...
  const postalCodeOnChangeHandler: any = useCallback(
      ...
      <main className={styles["main-container-style"]}>
        ...
        >
          <div className={styles["forms-sections-containers"]}>
            <label className={styles["labels-styling"]} htmlFor='postalCode'>
              CEP
            </label>
            <input
              {...register("postalCode")}
          ...
          <div className={styles["forms-sections-containers"]}>
            <label className={styles["labels-styling"]} htmlFor='baseAddress'>
              Endereço
            </label>
          ...
          <div className={styles["forms-sections-containers"]}>
            <label
              className={styles["labels-styling"]}
              htmlFor='baseAddressNumber'
            >
              Número
            </label>
            <input
          ...
          <div className={styles["forms-sections-containers"]}>
            <label className={styles["labels-styling"]} htmlFor='neighborhood'>
              Bairro
            </label>
            {isLoading && <div className={styles["loading-spinner"]} />}
            <input
          ...
          <div className={styles["forms-sections-containers"]}>
            <label className={styles["labels-styling"]} htmlFor='cityName'>
              Cidade
            </label>
            <input
              {...register("cityName")}
          ...
          <div className={styles["forms-sections-containers"]}>
            <label className={styles["labels-styling"]} htmlFor='stateName'>
              Estado
            </label>
            {isLoading && <div className={styles["loading-spinner"]} />}
            <input
